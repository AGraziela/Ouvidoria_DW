...
<head>
    ...
    <title>Ouvidoria - Cadastro</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css" rel="stylesheet">
    <link rel="stylesheet" href="style_cad.css"> </head>
<body>
...
<main class="container">
    <div class="card_formulario">
        ...
        <form action="processa_cadastro.php" method="POST">
            ...
            <button type="submit" class="botao">Finalizar Cadastro</button>
            
            <div class="form_links">
                <p>Já possui uma conta? <a href="login.php" class="link_destaque">Faça Login</a></p>
                <br>
                <a href="index.php" class="link_voltar">
